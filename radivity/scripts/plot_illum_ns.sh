...
set palette function (1-(1/exp(5*gray))), (1-(1/exp(5*gray))), 0
...
set label 1 at graph ${13} , graph 0.4  font ",22"
set label 1 "Av. Illum.:  $6" 
set label 2 at graph ${13}, graph 0.35  font ",22"
set label 2 "Min/Av. Illum.:  $7" 
set label 3 at graph ${13}, graph 0.3  font ",22"
set label 3 "% ($3-$5):  $8" 
set label 4 at graph ${13}, graph 0.25  font ",22"
set label 4 "% > $5:  $9" 
set label 5 at graph ${13}, graph 0.2  font ",22"
set label 5 "% < $3:  ${10}" 
