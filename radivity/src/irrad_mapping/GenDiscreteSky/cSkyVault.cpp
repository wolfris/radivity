...
//////////////
	...
	fprintf(stderr,"Total annual irradiation (Wh/m2): %f\n",m_annualIrradiance);
...
double cSkyVault::GetAnnualIrradiance() const
{
	return m_annualIrradiance;
}
